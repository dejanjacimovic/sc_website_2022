                ...
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    <ul className="mt-2 text-base leading-6 text-gray-500 list-disc pl-4">
                      ...
                      <li>Advanced pricing rules</li>
                      <li>Improved search results</li>
                      <li>Customer personalised products</li>
                      <li>Multi-tier upsell</li>
                    </ul>
                  </p>
                </div>
              </div>
                ...
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    <ul className="mt-2 text-base leading-6 text-gray-500 list-disc pl-4">
                      ...
                      <li>Popular items / search</li>
                      <li>Product reviews</li>
                      <li>Coupon usage</li>
                      <li>Total returns / refunds</li>
                    </ul>
                  </p>
                </div>
              </div>
