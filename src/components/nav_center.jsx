        ...
        <div className="relative pt-6 pb-12 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32">
              ...
              <div className="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                <div className="flex items-center justify-between w-full md:w-auto">
                  <a href="/" aria-label="Home">
                    <img className="h-8 w-auto sm:h-12" src="https://stcdshare.s3.amazonaws.com/RAsTG0DklW.png" alt="StuntCoders logo" />
                  </a>
                  <div className="-mr-2 flex items-center md:hidden">
                    <button className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out" id="main-menu" type="button" aria-label="Main menu" aria-haspopup="true" onclick="document.getElementById('main-mobile-menu').className='absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden z-50'">
                      <svg className="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg></button>
                  </div>
                </div>
              </div>
              <div className="hidden md:flex md:space-x-10">
                <div className="relative">
                  <button type="button" className="text-gray-500 group rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none" aria-expanded="false">
                    <span className="font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out" onclick="document.getElementById('service-submenu').classList.toggle('hidden')">Services</span>
                    <svg className="text-gray-400 ml-2 h-5 w-5 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" onclick="document.getElementById('service-submenu').classList.toggle('hidden')">
                    ...
                    <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                      <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                        ...
                        <a href="/services-ecommerce-development.php" className="-m-3 p-3 block rounded-md hover:bg-gray-50 transition ease-in-out duration-150">
                          ...
                          <p className="mt-1 text-sm text-gray-500">
                            Get all of your questions answered about eCommerce development.
                          </p>
                        </a>
                ...
                <a className="font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out" href="/testimonials.php">Testimonials</a>
                <a className="font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out" href="/portfolio.php">Portfolio</a>
                <a className="font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out" href="/pricing.php">Pricing</a>
                <a className="font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out" href="/about-us.php">About us</a>
              </div>
            ...
            <div className="rounded-lg shadow-md">
              <div className="rounded-lg bg-white shadow-xs overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
                ...
                <div className="px-2 pt-2 pb-3">
                  <div className="relative">
                    <button type="button" className="w-full px-3 py-2 text-gray-500 group rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 hover:bg-gray-50 focus:outline-none" aria-expanded="false" onclick="document.getElementById('service-submenu-mobile').classList.toggle('hidden')">
                      <span className="font-medium text-gray-700 hover:text-gray-900  focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">Services</span>
          ...
          <div className="relative pb-32 mt-8 bg-gray-800">
            <div className="absolute inset-0">
              <img className="w-full h-full object-cover" src="/images/working-class-hero.jpeg" alt="working class hero is soomething to be" />
              <div className="absolute inset-0 bg-gray-800 mix-blend-multiply" aria-hidden="true"></div>
            </div>
            <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
              <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl">We live and breathe eCommerce<br/>since 2010</h1>
              <p className="mt-6 max-w-3xl text-xl text-gray-300">Are you looking for experts to help you (re)launch, position, and grow your eCommerce business? We offer strategic services, including in-house design and development for eCommerce businesses. We work with companies like Camp David, Tesori, JumpKing, and Arduino.</p>
              <p className="mt-6 max-w-3xl text-xl text-gray-300">We accompany brands to success in the world of eCommerce by building scalable solutions that measure what matters—your sales.</p>
            </div>
          </div>

          <section className="-mt-32 max-w-7xl mx-auto relative z-10 pb-4 px-4 sm:px-6 lg:px-8" aria-labelledby="contact-heading">
            ...
            <div className="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
              <div className="flex flex-col bg-white rounded-2xl shadow-xl">
                <div className="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                  ...
                  <h3 className="text-xl font-medium text-gray-900">What makes us different?</h3>
                  <p className="mt-4 text-base text-gray-500">We deliver dedicated project manager, consultant, designer, and developer resources as part of a long-term engagement. This way, all of our resources are focused on becoming intimate with your business.</p>
                </div>
              </div>
              ...
              <div className="flex flex-col bg-white rounded-2xl shadow-xl">
                <div className="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                  ...
                  <p className="mt-4 text-base text-gray-500">We use Cloud services to eliminate the need for provisioning and managing infrastructure so our teams can focus more on generating business value for our customers.</p>
                </div>
              </div>
              ...
              <div className="flex flex-col bg-white rounded-2xl shadow-xl">
                <div className="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                  ...
                  <h3 className="text-xl font-medium text-gray-900">Team-as-a-Service</h3>
                  <p className="mt-4 text-base text-gray-500">While others use an hourly model, we provide well-balanced cross-functional teams that are the best fit for the assignment and responsibility for the quality and timeliness of software delivery.</p>
                </div>
              </div>
            </div>
          </section>
