...
function clients() {
  ...
  "LeCollab": [
    ...
    "image": "https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixqx=PxHbCpEsMp&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=8&w=1024&h=1024&q=80"
  ],
  "Selekkt": [
    ...
    <li>
      <div class="space-y-4">
        <div class="aspect-w-3 aspect-h-2">
          <img class="object-cover shadow-lg rounded-lg" src="{client['image']}" alt="{clientName}" />
        </div>
        ...
        <div class="space-y-2">
          ...
          <ul class="flex space-x-5">
            <li>
              <a href="<?php echo $client["link"]; ?>" target="_blank" class="text-gray-400 hover:text-gray-500">
