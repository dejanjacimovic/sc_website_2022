            ...
            <div className="md:flex-shrink-0">
              ...
              >
                ...
                >
                  ...
                  ></path>
                  <path d="M2328 393 c7 -3 16 -2 19 1 4 3 -2 6 -13 5 -11 0 -14 -3 -6 -6z"></path>
                  <path d="M2357 329 c-4 -16 -3 -18 9 -8 16 13 19 29 5 29 -5 0 -11 -9 -14 -21z"></path>
                  <path
          ...
          <div className="py-12 px-4 border-t-2 border-indigo-900 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
            <div className="md:flex-shrink-0">
              ...
              >
                ...
                ></path>
                <path d="M449.7,283.1c0-1.1-0.9-2-2-2c-1.2,0-2,0.8-1.9,2c0,1.2,0.8,1.7,1.8,1.9C448.7,285.2,449.7,284.2,449.7,283.1z"></path>
                <path
                ...
                ></path>
                <path d="M409.7,521.8c0.5,0,1,0.1,1.6,0.1c0,0.1,0,0.3,0,0.4c-0.5,0-1,0.1-1.5,0.1C409.7,522.2,409.7,522,409.7,521.8z"></path>
              </svg>
            </div>
            <blockquote className="mt-8 md:flex-grow md:flex md:flex-col">
              <div className="relative text-lg leading-7 font-medium text-white md:flex-grow">
