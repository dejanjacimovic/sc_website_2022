    ...
    <LayoutPage>
            ...
            <main className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h2 className="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                  ...
                  <span className="text-indigo-600">Marketplace on Magento</span>
                </h2>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">StuntCoders worked closely with Selekkt to develop and grow their brand through 10+ years and continues to manage their platform today with a dedicated team of 5 engineers and designers.</p>
              </div>
            </main>
          </div>
        </div>
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2"><StaticImage className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="../../images/cases/selekkt-main.jpeg" loading="auto" alt="Selekkt case study" /></div>
      </div>
      ...
      <div className="py-16 bg-gray-50 overflow-hidden lg:py-24">
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
          ...
          <h3 className="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">The Story</h3>
          ...
          <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div className="relative">
              <h4 className="text-2xl leading-8 font-extrabold text-gray-900 tracking-tight sm:text-3xl sm:leading-9">Collaborating Since 2010</h4>
            ...
            <div className="mt-10 -mx-4 relative lg:mt-0">
              ...
              <StaticImage className="relative mx-auto rounded-lg shadow-xl border-gray-200" width="490" src="../../images/cases/selekkt-growth.jpg" loading="auto" alt="Selekkt - Collaborating since 2010" />
            </div>
          </div>
          ...
          <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div className="lg:col-start-2">
              <h4 className="text-2xl leading-8 font-extrabold text-gray-900 tracking-tight sm:text-3xl sm:leading-9">YOY Growth</h4>
              <p className="mt-3 text-lg leading-7 text-gray-500">
                What started as a journey of 1.000 creative people sell unique products on selekkt.com turned into 40.000 vendors. Far from the mainstream, you will find furniture and furnishings, unusual fashion and bags, hand-printed posters and prints, but also delicacies and elegant technical accessories.
              </p>
              <p className="mt-3 text-lg leading-7 text-gray-500">
              ...
              <p className="mt-3 text-lg leading-7 text-gray-500">
                When landing on selekkt.com, customers now experience a fast, design-oriented storefront and feel a unique shopping experience instead of a large marketplace.
              </p>
            </div>
            <div className="mt-10 -mx-4 relative lg:mt-0 lg:col-start-1">
              ...
              <StaticImage className="relative mx-auto rounded-lg shadow-xl border-gray-200" width="490" src="../../images/cases/selekkt-good-vibes.jpeg" alt="Selekkt's Growth" loading="auto" />
            </div>
          </div>
          </div>
        </div>
      ...
      <section className="bg-white overflow-hidden"><div className="relative max-w-screen-xl mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 lg:py-20">
          <svg className="absolute top-full left-0 transform translate-x-80 -translate-y-24 lg:hidden" width="784" height="404" fill="none" viewbox="0 0 784 404"><defs><pattern id="e56e3f81-d9c1-4b83-a3ba-0d0ac8c32f32" x="0" y="0" width="20" height="20" patternunits="userSpaceOnUse"><rect className="text-gray-200" x="0" y="0" width="4" height="4" fill="currentColor"></rect></pattern></defs><rect width="784" height="404" fill="url(#e56e3f81-d9c1-4b83-a3ba-0d0ac8c32f32)"></rect></svg><svg className="hidden lg:block absolute right-full top-1/2 transform translate-x-1/2 -translate-y-1/2" width="404" height="784" fill="none" viewbox="0 0 404 784"><defs><pattern id="56409614-3d62-4985-9a10-7ca758a8f4f0" x="0" y="0" width="20" height="20" patternunits="userSpaceOnUse"><rect className="text-gray-200" x="0" y="0" width="4" height="4" fill="currentColor"></rect></pattern></defs><rect width="404" height="784" fill="url(#56409614-3d62-4985-9a10-7ca758a8f4f0)"></rect></svg><div className="relative lg:flex lg:items-center">
            <div className="hidden lg:block lg:flex-shrink-0"><StaticImage className="h-64 w-64 rounded-full xl:h-80 xl:w-80" src="../../images/cases/janrode.jpeg" alt="Jan Rode's testimonial" loading="auto" /></div>
            <div className="relative lg:ml-10">
              <svg className="absolute top-0 left-0 transform -translate-x-8 -translate-y-24 h-36 w-36 text-indigo-200 opacity-50" stroke="currentColor" fill="none" viewbox="0 0 144 144"><path stroke-width="2" d="M41.485 15C17.753 31.753 1 59.208 1 89.455c0 24.664 14.891 39.09 32.109 39.09 16.287 0 28.386-13.03 28.386-28.387 0-15.356-10.703-26.524-24.663-26.524-2.792 0-6.515.465-7.446.93 2.327-15.821 17.218-34.435 32.11-43.742L41.485 15zm80.04 0c-23.268 16.753-40.02 44.208-40.02 74.455 0 24.664 14.891 39.09 32.109 39.09 15.822 0 28.386-13.03 28.386-28.387 0-15.356-11.168-26.524-25.129-26.524-2.792 0-6.049.465-6.98.93 2.327-15.821 16.753-34.435 31.644-43.742L121.525 15z"></path></svg><blockquote className="relative">
                <div className="text-2xl leading-9 font-medium text-gray-900">
                  <p>There’s so much mutual trust between us that we don’t even think of them as a vendor anymore.</p>
                </div>
                <footer className="mt-8"><div className="flex">
                    <div className="flex-shrink-0 lg:hidden"><StaticImage className="h-12 w-12 rounded-full" src="../../images/cases/janrode.jpeg" alt="Jan Rode's testimonial" loading="auto" /></div>
                    <div className="ml-4 lg:ml-0">
                      <div className="text-base leading-6 font-medium text-gray-900">Jan Rode</div>
                      <div className="text-base leading-6 font-medium text-indigo-600">Managing partner, selekkt Digital GmbH</div>
                    </div>
                  </div>
                </footer></blockquote>
            </div>
      ...
      <div className="relative bg-gray-900">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
          <div className="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
            ...
            <p className="mt-5 text-lg text-gray-300">Learn more about what efforts we have put together to help Selekkt grow.</p>
            <div className="mt-8 overflow-hidden">
              <dl className="-mx-8 -mt-8 flex flex-wrap">
                ...
                <div className="flex flex-col px-8 pt-8">
                  ...
                  <dd className="order-1 text-2xl leading-8 font-extrabold sm:text-3xl sm:leading-9 bg-gradient-to-r from-purple-300 to-indigo-300 bg-clip-text text-transparent">10+ years</dd>
                </div>
                <div className="flex flex-col px-8 pt-8">
                  <dt className="order-2 text-base leading-6 font-medium text-gray-300">framework of choice</dt>
                  <dd className="order-1 text-2xl leading-8 font-extrabold sm:text-3xl sm:leading-9 bg-gradient-to-r from-purple-300 to-indigo-300 bg-clip-text text-transparent">Magento</dd>
                </div>
                <div className="flex flex-col px-8 pt-8">
                  <dt className="order-2 text-base leading-6 font-medium text-gray-300">orchestration</dt>
                  <dd className="order-1 text-2xl leading-8 font-extrabold sm:text-3xl sm:leading-9 bg-gradient-to-r from-purple-300 to-indigo-300 bg-clip-text text-transparent">Kubernetes</dd>
                </div>
              </dl>
            </div>
          </div>
      ...
      <div className="bg-gray-50">
        <div className="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl leading-9 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
            ...
            <br><span className="text-indigo-600">We'll get you covered.</span>
          </h2>
          <div className="mt-8 flex lg:flex-shrink-0 lg:mt-0">
            ...
            <div className="ml-3 inline-flex rounded-md shadow">
              <a className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-indigo-600 bg-white hover:text-indigo-500 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out" href="/testimonials.php">What did our customers say?</a>
            </div>
          </div>
        </div>
      </div>
