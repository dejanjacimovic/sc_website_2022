    ...
    <LayoutPage>
      <div class="relative bg-gray-50 overflow-hidden">
        ...
        <div class="relative pt-6 pb-12 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32">
          ...
          <div class="relative pb-32 mt-8 bg-gray-800">
            <div class="absolute inset-0">
              <img class="w-full h-full object-cover" src="/images/working-class-hero.jpeg" alt="Working class hero is something to be" />
              <div class="absolute inset-0 bg-gray-800 mix-blend-multiply" aria-hidden="true"></div>
            </div>
            <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
              <h1 class="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl">We live and breathe eCommerce<br/>since 2010</h1>
              <p class="mt-6 max-w-3xl text-xl text-gray-300">Are you looking for experts to help you (re)launch, position, and grow your eCommerce business? We offer strategic services, including in-house design and development for eCommerce businesses. We work with companies like Camp David, Tesori, JumpKing, and Arduino.</p>
              <p class="mt-6 max-w-3xl text-xl text-gray-300">We accompany brands to success in the world of eCommerce by building scalable solutions that measure what matters—your sales.</p>
            </div>
          </div>

          <section class="-mt-32 max-w-7xl mx-auto relative z-10 pb-4 px-4 sm:px-6 lg:px-8" aria-labelledby="contact-heading">
            ...
            <div class="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
              <div class="flex flex-col bg-white rounded-2xl shadow-xl">
                <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                  ...
                  <h3 class="text-xl font-medium text-gray-900">What makes us different?</h3>
                  <p class="mt-4 text-base text-gray-500">We deliver dedicated project manager, consultant, designer, and developer resources as part of a long-term engagement. This way, all of our resources are focused on becoming intimate with your business.</p>
                </div>
              </div>
              ...
              <div class="flex flex-col bg-white rounded-2xl shadow-xl">
                <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                  ...
                  <h3 class="text-xl font-medium text-gray-900">Cloud</h3>
                  <p class="mt-4 text-base text-gray-500">We use Cloud services to eliminate the need for provisioning and managing infrastructure so our teams can focus more on generating business value for our customers.</p>
                </div>
              </div>
              ...
              <div class="flex flex-col bg-white rounded-2xl shadow-xl">
                <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                  ...
                  <h3 class="text-xl font-medium text-gray-900">Team-as-a-Service</h3>
                  <p class="mt-4 text-base text-gray-500">While others use an hourly model, we provide well-balanced cross-functional teams that are the best fit for the assignment and responsibility for the quality and timeliness of software delivery.</p>
                </div>
              </div>
            </div>
          </section>
