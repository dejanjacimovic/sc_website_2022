    ...
    <LayoutPage>
              ...
              <div class="pt-6">
                <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div class="-mt-6">
                    ...
                    <h3 class="mt-8 text-lg font-medium text-gray-900 tracking-tight">Our Main Platforms</h3>
              ...
              <div class="pt-6">
                <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div class="-mt-6">
                    ...
                    <h3 class="mt-8 text-lg font-medium text-gray-900 tracking-tight">Our Main Technology Stack</h3>
                    <ul class="mt-2 text-base leading-6 text-gray-500 list-disc pl-4">
                      <li>PHP</li>
                      <li>Ruby on Rails</li>
                      <li>Python</li>
              ...
              <div class="pt-6">
                <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div class="-mt-6">
                    ...
                    <h3 class="mt-8 text-lg font-medium text-gray-900 tracking-tight">Industries</h3>
                    <ul class="mt-2 text-base leading-6 text-gray-500 list-disc pl-4">
                      <li>Fashion</li>
                      <li>Technology</li>
                      <li>Commodity</li>
              ...
              <div class="max-w-md mx-auto space-y-4 lg:max-w-5xl lg:grid lg:grid-cols-2 lg:gap-5 lg:space-y-0">
                <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                  <div class="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                    <h3 class="mt-5 text-gray-900 text-3xl font-extrabold">Micro-team</h3>
                    <div class="mt-4 flex items-baseline text-xl font-extrabold">
                      from 7.200 €
                      <span class="ml-1 text-l font-medium text-gray-500">
                        /mo
                      </span>
                    </div>
                  ...
                  <div class="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
                    ...
                    <div class="rounded-md shadow">
                      <a href="/contact-us.php?subject=Micro%team" class="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-800 hover:bg-gray-900" aria-describedby="tier-standard">
                        Get started
                      </a>
                    </div>
                  </div>
                ...
                <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                  <div class="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                    <h3 class="mt-5 text-gray-900 text-3xl font-extrabold">Accelerated Development</h3>
                    <div class="mt-4 flex items-baseline text-xl font-extrabold">
                      from 11.250 €
                      <span class="ml-1 text-l font-medium text-gray-500">
                        /mo
                  ...
                  <div class="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
                    ...
                    <div class="rounded-md shadow">
                      <a href="/contact-us.php?subject=Accelerated%development" class="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-800 hover:bg-gray-900" aria-describedby="tier-standard">
                        Get started
                      </a>
                    </div>
                  </div>
          ...
          <div class="mt-4 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:mt-5">
            <div class="max-w-md mx-auto lg:max-w-5xl">
              <div class="rounded-lg bg-gray-100 px-6 py-8 sm:p-10 lg:flex lg:items-center">
                <div class="flex-1">
                  <div class="mt-4 text-lg text-gray-600">We create long-lasting relationships with our clients and focus on communicating with them to ensure they are always in control.</div>

                  <div class="mt-4 text-lg text-gray-600">Our Accelerated Development delivery method is a perfect fit for more significant innovation initiatives, where roadmaps and backlogs exist and stretch over a more extended period.</div>

                  <div class="mt-4 text-lg text-gray-600">You control the direction and focus of the teams and adjust their priorities to align with your business needs in an agile way.</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="relative bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
        ...
        <div class="relative max-w-7xl mx-auto">
          <div class="text-center">
            ...
            <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4 hidden">
            </p>
          </div>
          <div class="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
            <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
              ...
              <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                <div class="flex-1">
                  ...
                  <a href="/case/tesori.php" class="block mt-2">
                ...
                <div class="mt-8 text-center md:flex md:items-center">
                  <div class="text-base font-medium text-gray-900">Team: Micro-team</div>
                  ...
                  <div class="text-base font-medium text-gray-500">Length: 8+ years</div>
                </div>
              </div>
              <div class="p-6 bg-gray-50 rounded-bl-2xl rounded-br-2xl">
                <a href="/case/tesori.php" class="text-base font-medium text-indigo-700 hover:text-indigo-600">Read the study<span aria-hidden="true"> →</span></a>
              </div>
            </div>
            ...
            <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
              ...
              <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                <div class="flex-1">
                  ...
                  <a href="/case/camp-david.php" class="block mt-2">
                    <p class="text-xl font-semibold text-gray-900">
                      Camp David & Soccx
                    </p>
                    <p class="mt-3 text-base text-gray-500">
                ...
                <div class="mt-8 text-center md:flex md:items-center">
                  <div class="text-base font-medium text-gray-900">Team: 10+</div>
                  <svg class="hidden md:block mx-1 h-5 w-5 text-indigo-600" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M11 0h3L9 20H6l5-20z"></path>
                  </svg>
                  <div class="text-base font-medium text-gray-500">Length: 4+ years</div>
                </div>
              </div>
              <div class="p-6 bg-gray-50 rounded-bl-2xl rounded-br-2xl">
                <a href="/case/camp-david.php" class="text-base font-medium text-indigo-700 hover:text-indigo-600">Read the study<span aria-hidden="true"> →</span></a>
              </div>
            </div>
            ...
            <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
              ...
              <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                ...
                <div class="mt-8 text-center md:flex md:items-center">
                  <div class="text-base font-medium text-gray-900">Team: 5+</div>
                  <svg class="hidden md:block mx-1 h-5 w-5 text-indigo-600" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M11 0h3L9 20H6l5-20z"></path>
                  </svg>
                  <div class="text-base font-medium text-gray-500">Length: 10+ years</div>
                </div>
              </div>
              <div class="p-6 bg-gray-50 rounded-bl-2xl rounded-br-2xl">
                <a href="/case/selekkt.php" class="text-base font-medium text-indigo-700 hover:text-indigo-600">Read the study<span aria-hidden="true"> →</span></a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="mt-10 sm:grid sm:grid-cols-2 sm:col-gap-8 sm:row-gap-10 lg:col-span-2 lg:mt-0">
              <div>
                ...
                <div class="mt-5 pr-4">
                  ...
                  <p class="mt-2 text-base leading-6 text-gray-500">Our team of DevOps is there to make sure your systems are running smoothly 24/7 so that you don't need to dedicate any additional resources to run your online store.</p>
                  <br/>
                </div>
              </div>
              <div class="mt-10 sm:mt-0 pb-4">
                ...
                <div class="mt-5 pb-4">
                  <h4 class="text-lg leading-6 font-medium text-gray-900">Distributed Network</h4>
                  <p class="mt-2 text-base leading-6 text-gray-500">Distributed networks of computers are there to provide you with exceptional deliverability, so you can always stay online even in the unlikely event of increased loads or outside attacks.</p>
                </div>
              </div>
              <div class="mt-10 sm:mt-0">
                ...
                <div class="mt-5 pr-4">
                  ...
                  <p class="mt-2 text-base leading-6 text-gray-500">Our backup systems are made in such a manner that partial updates get performed every minute to make sure your system is possible to recover without any data loss. Full backups get performed daily.</p>
                </div>
              </div>
              <div class="mt-10 sm:mt-0">
                <div class="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
                ...
                <div class="mt-5 pr-4">
                  <h4 class="text-lg leading-6 font-medium text-gray-900">GDPR Compliance</h4>
                  <p class="mt-2 text-base leading-6 text-gray-500">Our team will make sure you stay up to date with GDPR with data processing audits, privacy policy checks, and communication with your legal team upon new tools implemented while recording awareness of the customer so that in an unlikely event of user reporting, you have the evidence of rightdoing.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="bg-white">
        <div class="max-w-7xl mx-auto text-center py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            <span class="block">Marketplaces under your fingertips</span>
          </h2>

          <p class="max-w-xl mt-5 mx-auto text-xl text-gray-500">Speed up deals with the ability to sell on marketplaces through integrated platforms and reach a wider audience through Amazon, Zalando, Otto, and hundreds of others.</p>

          <p class="max-w-xl mt-5 mx-auto text-xl text-gray-500">Once implemented, our customers have seen a 5x increase in revenue in the first year and a steady 1.3x year over year after the first year.</p>
          ...
          <div class="mt-8 flex justify-center">
            <div class="inline-flex rounded-md shadow">
              <a href="/contact-us.php?subject=marketplaces" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
            ...
            <div>
              ...
              <div class="mt-8 sm:flex">
                <div class="mt-3 sm:mt-0">
                  <a href="/contact-us.php?subject=ecommerce%20development" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
                    Contact Us
                  </a>
                </div>
              </div>
      ...
      <div class="py-16 bg-gray-50 overflow-hidden lg:py-24">
        <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
          ...
          <h3 class="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">Accelerate Your Development</h3>
          <p class="mt-4 max-w-3xl mx-auto text-center text-xl leading-7 text-gray-500">Shortage of tech talent is one of the biggest challenges businesses face today regarding technology innovation.</p>
          <p class="mt-4 max-w-3xl mx-auto text-center text-xl leading-7 text-gray-500">StuntCoders accelerates product roadmaps and helps modernize tech stacks by becoming a trusted technology partner and an extension of your in-house team.</p>
          </div>
          <div class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div class="relative">
              <h4 class="text-2xl leading-8 font-extrabold text-gray-900 tracking-tight sm:text-3xl sm:leading-9">In-sourcing</h4>
          ...
          <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div class="lg:col-start-2">
              <h4 class="text-2xl leading-8 font-extrabold text-gray-900 tracking-tight sm:text-3xl sm:leading-9">Why does it make sense?</h4>
      ...
      <div class="bg-white">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
          <div class="max-w-3xl mx-auto text-center">
            <h2 class="text-3xl font-extrabold text-gray-900">Choose an Experienced Integrator</h2>
            <p class="mt-4 text-lg text-gray-500">Over the 10+ years, we have delivered 60+ highly successful online stores and have successfully connected online stores to ERP, warehouse systems, and CRMs.</p>
            <p class="mt-4 text-lg text-gray-500">Integrating your internal tools into your website can be a tedious task prone to failure. By choosing a partner with experience with the following systems, you reduce time to market and uncertainty.</p>
          </div>
          <dl class="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-4 lg:gap-x-8">
            <div class="relative">
              <dt>
                ...
                <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Visma</p>
              </dt>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Mamut</p>
              </dt>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Microsoft Dynamics</p>
              </dt>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-9 text-lg leading-6 font-medium text-gray-900">SAP</p>
              </dt>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Odoo</p>
              </dt>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Salesforce</p>
              </dt>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Pimcore</p>
              </dt>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-9 text-lg leading-6 font-medium text-gray-900">SuperOffice</p>
              </dt>
            </div>
          </dl>
        </div>
      ...
      <div class="bg-indigo-50">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-24 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 md:text-4xl">
            ...
            <span class="block text-indigo-600">Book your call today.</span>
          </h2>
          <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
            <div class="inline-flex rounded-md shadow">
              <a href="/contact-us.php?subject=Book%20call" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                Get started
              </a>
            </div>
          </div>
